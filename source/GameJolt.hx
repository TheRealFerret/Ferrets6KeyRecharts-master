...
{    
    ...
    */
    ...
    public static var textArray:Array<String> = [
        "Do you like my recharts?",
        "swag swag swag swag swag swag",
        "youcantrunwhileyouarehavingfunyoucantrunwhileyouarehavingfunyoucantrunwhileyouarehavingfunyoucantrunwhileyouarehavingfunyoucantrunwhileyouarehavingfunyoucantrunwhileyouarehavingfun",
        "You should login, that would be cool.",
        "I love Cheeky mod",
        ":troll:",
        "You should also play Abyss' 7 Key Recharts.",
        "You should also play UnknownPlayer's Extra Key Recharts",
        "how to be funny 101",
        ":)",
        "You're too slow.",
        "hey kid, what's your password",
        "amongla",
        "turn on the sick only modifier, it will be fun"
    ];
}
...
class GameJoltLogin extends MusicBeatSubstate
{
    ...
    override function create()
    {
        ...
        funnyText = new FlxText(5, FlxG.height - 40, 0, GameJoltInfo.textArray[FlxG.random.int(0, GameJoltInfo.textArray.length - 1)]+ " -Ferret", 12);
        add(funnyText);
